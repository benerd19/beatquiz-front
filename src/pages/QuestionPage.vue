...
<template>
    ...
    <!-- <audio
        @
        src="https://cdnt-preview.dzcdn.net/api/1/1/9/0/0/0/900393147281069933013563cea5817b.mp3?hdnea=exp=1778781254~acl=/api/1/1/9/0/0/0/900393147281069933013563cea5817b.mp3*~data=user_id=0,application_id=42~hmac=3edafdb4b589b3715e8389a4f33045cb958346c153749f3ca8a65d1c05fbb398"
    /> -->
    ...
    <div class="modal__duration">
        <div class="modal__duration">
            ...
            <button @click.prevent="togglePlay">Play</button>
        </div>
    </div>
</template>
